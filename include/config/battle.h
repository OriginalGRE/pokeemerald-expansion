...
#define B_CRITICAL_CAPTURE_IF_OWNED     FALSE // In Gen9, a capture appear critical if the pokemon you are trying to catch already has a dex entry (has already been caught)
